...
from acd_program.db.puppet import Puppet as DBPuppet
...
class Puppet(DBPuppet, BasePuppet):
    ...
    async def get_by_mxid(cls, mxid: UserID, create: bool = True) -> Puppet | None:
        return await cls.get_puppet_by_mxid(mxid, create=create)
    ...
    @classmethod
    def get_mxid_from_id(cls, id: int) -> UserID:
        return UserID(cls.mxid_template.format_full(id))
