...
if os.path.exists(".git") and shutil.which("git"):
    try:
        ...
        git_revision_url = f"https://gitlab.com/iKono/acd-appservice/-/commit/{git_revision}"
...
git_tag_url = f"https://gitlab.com/iKono/acd-appservice/-/tags/{git_tag}" if git_tag else None
