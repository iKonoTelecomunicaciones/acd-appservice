...
async def acd(request: web.Request) -> web.Response:
    ...
    put_in_pending_room = data.get("put_in_pending_room") or False
    ...
    args = [customer_room_id, campaign_room_id, joined_message, put_in_pending_room]
